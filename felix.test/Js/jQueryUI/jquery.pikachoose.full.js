    ...
    $pc.fn.extend({
        ...
        build: function() {
       	...
       	//create the structure for pikachoose
			...
			this.textPrev 	= $("<span class='previous'>"+this.options.text.previous+"</span>").appendTo(this.textNav);
			
			this.captions 	= $("<span class='captions'>title</span>").appendTo(this.textNav);
...
//modify by jixj: modify Thumb height
         ...
         */
	     ...
	     finishAnimating: function(data){
     		...
     		//alert(data.source);
     		this.aniDiv.hide();
//click alter new windows for big picture modify by jixj
     		...
     		if(this.options.showCaption && data.caption != "" && data.caption != null){
     			...
     			var strcaption = data.caption ;
				strcaption = strcaption.substring(0,strcaption.lastIndexOf("."))
			
     			this.captions.html(strcaption).stop(true,true).fadeIn('slow');
     		}
